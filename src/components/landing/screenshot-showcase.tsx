...
interface ScreenshotShowcaseProps {
  /** Optional override for screenshot URLs (e.g. Saas page uses checkout instead of docseek). */
  screenshots?: string[];
}

export const ScreenshotShowcase = ({ screenshots = DEFAULT_SCREENSHOTS }: ScreenshotShowcaseProps) => {
  return (
