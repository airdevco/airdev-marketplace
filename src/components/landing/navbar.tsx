    ...
    >
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="flex items-center justify-between relative">
          ...
          <div className="hidden lg:block flex-shrink-0">
            <a href="#talk-to-us-heading" onClick={(e) => handleSmoothScroll(e, "#talk-to-us-heading")}>
      ...
      {mobileMenuOpen && (
        <div className="absolute top-full left-0 right-0 bg-white border-b border-gray-200 p-6 lg:hidden flex flex-col gap-1 shadow-xl max-h-[calc(100vh-80px)] overflow-y-auto">
          ...
          <a href="#talk-to-us-heading" onClick={(e) => { handleSmoothScroll(e, "#talk-to-us-heading"); closeMobileMenu(); }} className="mt-2">
